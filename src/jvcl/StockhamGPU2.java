...
public class StockhamGPU2 {
	...
	public StockhamGPU2() {	
		...
		Kernel = program.createCLKernel("stockham2");
	}
	
	
	public StockhamGPU2(CLContext context, CLDevice device, CLCommandQueue queue, CLProgram program) {
	...
	void fft(float[] real, float[] imag, boolean isForward, int blockSize) {
	    ...
	    N = blockSize;
	    int pwr2N = (int)(Math.log(N)/Math.log(2));
	...
	public static void main(String[] args) {
		StockhamGPU2 s = new StockhamGPU2();
